...
#NOTE: USE THIS TO SEE IF YOU CAN MAKE THIS BETTER BY USING THE UNREGISTER METHOD TO DO WHAT YOU ORIGINALLY WANTED BY CHECKING ALL THE ANGLES AND MOVING ACCORIDNG
#I.E. MAKE A LIST OF LEFT AND RIGHT QUADRANTS, RUN THROUGH THE LIST, IF ANY IS SMALLER THAN THRESHOLD, NOW UNREGISTER FRON SUBSCRIPTION, MOVE ACCORDINGLY
#AND REGISTER TO CHECK AGAIN, MAKE PUT TINY STOP SO THAT IT CAN PROCESS. ALSO IN THE PAST WHAT HAPPENED IS THAT WHEN IT RAN THROUGH, IT RAN THROUGH ALL OF THE
#SENSORS AND MOVED ACCORDINGLY, AS IT DID NOT STOP, THE ROBOT KEPT MOVING ACCORDING TO THE PREVOIUS VALUES BUT NOT U CAN STOP WITH THE UNREGISTER SO SEE WAT
#U CAN DO
